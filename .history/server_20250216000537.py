...
def save_signature():
    ...
    try:
        ...
        print("Base64 data after padding correction:", signature_data[:30] + "...")
        ...
        try:
            ...
            if os.path.exists(file_path):
                print("File verification: exists, size:", os.path.getsize(file_path), "bytes")
                print("File permissions:", oct(os.stat(file_path).st_mode)[-3:])
