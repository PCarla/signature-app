...
def validate_base64(data):
    """
    Validates that the string is properly base64-encoded and corrects padding if necessary.
    """
    try:
...
def generate_pdf(adresse, tonnen_anzahl, datum, signature_base64, output_filename):
    ...
    try:
        ...
        if len(signature_bytes) < 100:  # PNG files are generally larger; adjust as needed
...
tonnen_anzahl = 3
datum = "2023-10-10"
# Example valid base64-encoded PNG data
signature_base64_example = (
    "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAABU0lEQVR42mJkQAJ2A/3794MJDQ0ZsP"
    "379+/fFz586dxsbGczMzNTa2snJyUpKSvLw8OD7779fSUlJX3/+OXr06LFHjx6N7u7uyN27dyEgoLC"
    "YlJSEr1798rKyqI9e/bswcrKSnq9nTt3DgoKChMT0+v5uZmhoaG2Lnzp2bO2PGjFH27NlZWFiYGJgA"
    "sLExQWpqqtWrV2N/fz9GjBglJSWpqGg4cOBAjo6O8Ht3bp1sKFDh/j4+MjJyUnu/PnzgysrqxUWFhY"
    "GUlJSVdUVNTXX39+nTt3TtOnTc7NzVVWVoaGhizZsycDAwMxs7OTShp6eno6ODV1VVpaGhgYGEBLy8"
    "vI8evRIhoaGgoKCk5OTkpKSioqKX4WKFSubNm1i4cKGCg4NjKysrU1JSgubm5mJiYGNfWVqyqq1NQU"
    "FBVVdXZ2ZkZGRoaioqCgmJsbAxMzMrKysjI2NRcXF5uYmKioqFBXV1f55VdfnT17FhwcHBweHk5ubm"
    "Z4+ZmZm9vb2FhXl+/Hg0NDQ0NDRkZGZmZmZmFhQU5OTkZGBhwbG5uZmBgAAGMBv0+gkqbAAAAAElFT"
    "kSuQmCC"
)
# Name der Ausgabedatei
output_filename = "bestaetigung.pdf"
# PDF erstellen
generate_pdf(adresse, tonnen_anzahl, datum, signature_base64_example, output_filename)
