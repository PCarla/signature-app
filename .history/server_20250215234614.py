...
def save_signature():
    ...
    try:
        ...
        try:
            ...
            print("Full file path:", os.path.abspath(file_path))  # Debugging
            ...
            if os.path.exists(file_path):
                print("File verification: exists, size:",
                      os.path.getsize(file_path), "bytes")  # Debugging
                print("File permissions:",
                      oct(os.stat(file_path).st_mode)[-3:])  # Debugging


            else:
                print("File verification failed: file does not exist")  # Debugging
                print("Directory contents:", os.listdir(os.getcwd()))  # Debugging
